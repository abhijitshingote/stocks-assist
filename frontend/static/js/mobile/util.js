  ...
  function setupNotesModal() {
    ...
    window._copyWhyPrompt = async function (ticker, company, btn) {
      ...
      const text = 'What does ' + t + ' do? Why has it moved [up/down] recently? Search for current news.\n'
          + 'Format:\n'
          + '\n'
          + '1. Summary: 2 sentences max. What the company does (1 sentence) + what are its main current or future business verticals or products.\n'
          + '2. Why the stock is moving (2-3 sentences). List 1-2 most impactful factors only. prefereably with date/month\n'
          + '3. Drivers: 5-6 bullets max, one line each, ranked by importance. Each bullet MUST include a date and a named source (person, bank, or event) — no unnamed "analysts" or "strategists." Format: `[Date] — [specific event/number] → [stock impact if known]`\n'
          + '\n'
