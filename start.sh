...
*/30 9-20 * * 1-5 cd /app && DATABASE_URL=postgresql://postgres:postgres@db:5432/stocks_db POLYGON_API_KEY=${POLYGON_API_KEY} FMP_API_KEY=${FMP_API_KEY} /usr/local/bin/python daily_price_update.py >> /var/log/cron.log 2>&1
